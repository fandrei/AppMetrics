...
set _DeploySetParametersFile=%RootPath%AppMetrics.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%AppMetrics.zip" (
echo "%RootPath%AppMetrics.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%AppMetrics.deploy-readme.txt" (
...
start notepad "%RootPath%AppMetrics.deploy-readme.txt"
)
echo =========================================================
goto :eof
