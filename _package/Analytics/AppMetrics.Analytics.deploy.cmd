...
set _DeploySetParametersFile=%RootPath%AppMetrics.Analytics.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%AppMetrics.Analytics.zip" (
echo "%RootPath%AppMetrics.Analytics.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AppMetrics.Analytics.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:skipaction='Delete',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Delete',objectname='dirPath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='dirPath',absolutepath='\\App_Data\\.*' %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AppMetrics.Analytics.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:skipaction='Delete',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Delete',objectname='dirPath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='dirPath',absolutepath='\\App_Data\\.*' %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AppMetrics.Analytics.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:skipaction='Delete',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Delete',objectname='dirPath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='dirPath',absolutepath='\\App_Data\\.*' -setParamFile:"%RootPath%AppMetrics.Analytics.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AppMetrics.Analytics.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:skipaction='Delete',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Delete',objectname='dirPath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='filePath',absolutepath='\\App_Data\\.*' -skip:skipaction='Update',objectname='dirPath',absolutepath='\\App_Data\\.*' -setParamFile:"%RootPath%AppMetrics.Analytics.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%AppMetrics.Analytics.deploy-readme.txt" (
...
start notepad "%RootPath%AppMetrics.Analytics.deploy-readme.txt"
)
echo =========================================================
goto :eof
